...
--
-- Name: wells; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE "public"."wells" (
    "created_at" timestamp with time zone DEFAULT "now"(),
    "name" character varying,
    "x_location" character varying,
    "y_location" character varying,
...
ALTER TABLE "public"."wells" OWNER TO "supabase_admin";
...
--
-- Name: profiles users_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: wells wells_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: logs logs_well_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."logs"
    ADD CONSTRAINT "logs_well_id_fkey" FOREIGN KEY ("well_id") REFERENCES "public"."wells"("id");
...
--
-- Name: wells wells_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."wells"
    ADD CONSTRAINT "wells_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id");


--
-- Name: wells wells_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."wells"
    ADD CONSTRAINT "wells_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: logs allow all operations; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "allow all operations" ON "public"."logs" TO "anon", "authenticated" USING (true) WITH CHECK (true);


--
-- Name: projects allow all operations; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "allow all operations" ON "public"."projects" TO "anon", "authenticated" USING (true) WITH CHECK (true);


--
-- Name: wells allow all operations; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "allow all operations" ON "public"."wells" TO "anon", "authenticated" USING (true) WITH CHECK (true);


--
-- Name: profiles get user profile; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: wells; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: TABLE "wells"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."wells" TO "postgres";
